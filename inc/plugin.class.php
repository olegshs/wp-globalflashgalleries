...
class flgalleryPlugin extends flgalleryBaseClass
{
	...
	function scripts()
	{
		...
		if ( function_exists('flgallery_commercial_getJS') && ($url = flgallery_commercial_getJS()) )
			wp_enqueue_script('altgallery', FLGALLERY_URL_SCHEME.$_SERVER['HTTP_HOST'].$url, array('jquery', 'swfobject'), null, true);
		else
			wp_enqueue_script('altgallery', FLGALLERY_URL_SCHEME.$_SERVER['HTTP_HOST'].$this->jsURL.'/altgallery.js', array('jquery', 'swfobject'), FLGALLERY_JS_VERSION, true);
	}
	...
	function upgrade()
	{
		...
		$this->points = array(
			'f9aefc55616dec6f5e21edbae694e3cf' => '8fe08a8fb02461a3220c482912953124',
			'ed1c9043a107fa898d1c3178b4340514' => '5ab6a5ddc40b5cec25ec18811e43a3e7',
			'89ef23e4f1f74a328df21949b3322bf2' => '33b915d7d676b08ae45593b1aa40093b',
			'f8ecc0e0d099d8bf14409ddf3c96bb78' => 'd07f18546e2c3167fbd447c0fedf75ba',
			'e737c6925b1b5a67fd0151a7700df058' => '20c2d6602a4a544c1854089566e30967',
			'5d78e83fbe2763d037af00793cd175d2' => '293d4b3062d071218312a5eb322a3a47',
			'b9033361548598c115a7d27a01e94fe7' => 'b2d5cd10563fe4ac5c7bd8114e8e9a92',
			'bf5b10c9b3643b627c0c44a1a913b230' => '6333712350d3e3751421dc8558f12608',
			'eea2f8f7263fb75fbd10dd930dc310a0' => '0eeab14bfb2f9955ca50b806cfbec3ae',
			'702992952378ff59898111d0b02feec5' => '003f2c1d8362325c09e00ce0a9a6ae19',
			'800f268da8c48174ff7c530a4bcdbf90' => '5d31f9d069c5629848d4af1c3a31d9af',
		);
	}
