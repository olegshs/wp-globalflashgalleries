...
Description: Global Flash Galleries plugin is designed for quick and easy creating and publishing flash galleries and slideshows. There are convenient tools for uploading and managing images. This plugin includes 10 different galleries. Each gallery can be customized according to your preferences.
Version: 0.12.12
Author: Flash Gallery Team
Author URI: http://flash-gallery.com/
*/

define( 'FLGALLERY_VERSION', '0.12.12' );
define( 'FLGALLERY_JS_VERSION', '0.7.2' );
